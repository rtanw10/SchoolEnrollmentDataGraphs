...
/**
 * A Country object stores the data, name of country, and the year labels for a single country
 *
...
public class Country {
    ...
    /**
     * Initializes a single Country object that will store the name of country
     * @param name
     */
    ...
    /**
     * Checks whether a Country object is equal to another Country object
    ...
    public Indicator getIndicatorForYear(int wantedYear) throws IllegalArgumentException {
        ...
        while(iterator.hasNext()){
            ...
            else if(next.getYear() == wantedYear){
                return next;
            }
        }
    ...
    public void setIndicatorForYear(int requestedYear, Indicator data){
        ...
        while (iterator.hasNext()){
            ...
            else if(next.getYear() == requestedYear){
     ...
     * @return Returns a string representation of the Country Object
     */
